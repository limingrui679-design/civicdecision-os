...
| CORE-006 | Every source artifact has version, query, license, hash and record count | verified | Two real public connector artifacts, CLI verification, tamper/path/shape tests |
