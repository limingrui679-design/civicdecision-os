...
| Product projection drift | One validated `ArtifactStore`, closed enums, client-side SDK validation, deterministic 35-file projection, manifest, hashes, and exact rebuild | Compatibility policy and signed release snapshots |
