# San Francisco — Citywide service-request workload baseline

- Scenario: `tierd.us.ca.san-francisco.01`
- Application suite: `public-service-operations`
- Status: `completed`
- DecisionPack content hash: `sha256:abb2fd22ee673f67455c18b9be9ec4cae9289b78298b71657e8898b85bc124b4`

## Claim boundary

A reproducible planning comparison conditioned on observed aggregate request counts and explicit hypothetical action parameters.
...
| modeled-objective | 81.57031606557378 |
...
- **observed / established:** The declared focus rule matches 461,576 requests across 39 public category labels.
